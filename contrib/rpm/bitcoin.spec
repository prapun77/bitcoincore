...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 9495
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19495
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18443
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 29495
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 9495
	%{_sbindir}/semanage port -d -p tcp 18332
	%{_sbindir}/semanage port -d -p tcp 19495
	%{_sbindir}/semanage port -d -p tcp 18443
	%{_sbindir}/semanage port -d -p tcp 29495
	for selinuxvariant in %{selinux_variants}; do
