...
public:
    CMainParams() {
       ...
       // vSeeds.emplace_back("seed.bitcoin.sprovoost.nl"); // Sjors Provoost
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x06, 0x78, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x06, 0x78, 0xAD, 0xE4};
        ...
        chainTxData = ChainTxData{
            ...
            1532441738  , // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
      ...
      //consensus.BIP34Hash = uint256S("0x0000000023b3a96d3484e5abb3755c413e7d41500f8e2a5c3f0dd01299cd8ef8");
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0x14, 0x36, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x14, 0x36, 0x83, 0x94};
